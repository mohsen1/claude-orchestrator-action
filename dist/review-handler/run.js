...
Please make the required changes now.`;
    ...
    try {
        ...
        for (const comment of comments) {
            ...
            try {
                await github.replyToReviewComment(prNumber, comment.id, `Addressed in the latest commit.\n\n---\n*Automated response*`);
            }
            catch (e) {
