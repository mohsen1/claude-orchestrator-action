...
import { readDirectorState, readEmState, readWorkerState, } from '../shared/state.js';
/**
 * Watchdog class
 */
export class Watchdog {
     ...
     */
    async markIssueStalled(issueNumber, stalled) {
        try {
            // Add stalled label
     ...
     */
    async recoverStalled(component) {
     ...
     */
    async recoverDirector(component) {
