 ...
 */
export function getOrchestratorLabels(labels) {
    return labels.filter(isOrchestratorLabel);
}
/**
 * Get current status from labels
 */
export function getStatusFromLabels(labels) {
 ...
 */
export function getPhaseFromLabels(labels) {
 ...
 */
export function getEMIdFromLabels(labels) {
 ...
 */
export function createEMLabel(emId) {
    return `${LABEL_PREFIXES.EM}${emId}`;
}
/**
 * Map internal worker status to label
 */
export function workerStatusToLabel(status) {
    switch (status) {
        case 'pending':
 ...
 */
export function labelToWorkerStatus(label) {
    switch (label) {
 ...
 */
export function labelToPhase(label) {
    switch (label) {
