 ...
 */
export function getDirectorBranch(issueNumber, slug) {
 ...
 */
export function getEmBranch(directorBranch, emId) {
 ...
 */
export function getWorkerBranch(emBranch, workerId) {
 ...
 */
export function parseComponentFromBranch(branch) {
    const result = {
        type: null,
        issueNumber: null,
        emId: null,
 ...
 */
export function isValidOrchestratorBranch(branch) {
 ...
 */
export function getBaseBranch(branch) {
    const parsed = parseComponentFromBranch(branch);
